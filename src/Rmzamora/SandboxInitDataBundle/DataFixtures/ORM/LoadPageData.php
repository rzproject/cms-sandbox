...
<p>
    This page is a demo of the cms-sandbox Sandbox available on <a href="https://github.com/sonata-project/sandbox">github</a>.
...
CONTENT
    ...
    public function createGlobalPage(SiteInterface $site)
    {
        ...
        $text->setType('sonata.block.service.text');
        $text->setSetting('content', '<h2><a href="/">cms-sandbox</a></h2>');
        $text->setPosition(1);
        $text->setEnabled(true);
        $text->setPage($global);
        ...
        <a href="http://www.mellzamora.com">cms-sandbox (c) mellzamora.com 2013</a>.

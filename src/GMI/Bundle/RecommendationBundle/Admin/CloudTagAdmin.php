...
class CloudTagAdmin extends Admin
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $formMapper
            ->add('tag', 'sonata_type_model_list',array('required' => false, 'attr'=>array('class'=>'span8')), array('link_parameters' => array('context' => 'news', 'hide_context' => true)))
    ...
    {
        $listMapper
            ->addIdentifier('tag.name', null, array('footable'=>array('attr'=>array('data_toggle'=>true))))
